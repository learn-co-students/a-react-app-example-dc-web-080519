...
of exports, like named exports and default exports, but we'll go over that in detail later.

For now, we will focus on default exports. The line, `export default App` denotes that
